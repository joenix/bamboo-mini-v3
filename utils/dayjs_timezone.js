  ...
  return function (n, i, o) {
        ...
        var o = new Date(t),
          r = (function (t, n) {
            ...
            var i = n.timeZoneName || 'short',
              o = t + '|' + i,
              r = e[o];
            return r || ((r = new Intl.DateTimeFormat('en-US', { hour12: !1, timeZone: t, year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', second: '2-digit', timeZoneName: i })), (e[o] = r)), r;
          })(n, i);
    ...
    (f.tz = function (t, e) {
      ...
      var n,
        i = this.utcOffset(),
        a = this.toDate(),
        u = a.toLocaleString('en-US', { timeZone: t }),
